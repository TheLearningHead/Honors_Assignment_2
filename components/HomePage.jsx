    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.iconRow}>
          ...
          <MaterialIcons name="shopping-cart" size={24} color="black" style={styles.iconSpacing} />
      ...
      <View style={styles.walletContainer}>
        <View style={styles.walletItem}>
          <FontAwesome name="wallet" size={20} color="black" />
      ...
      <View style={styles.categoriesContainer}>
        ...
        <View style={styles.categoriesRow}>
          <View style={styles.category}>
            <FontAwesome name="shoe-prints" size={20} color="black" />
...
const styles = StyleSheet.create({
  ...
  searchContainer: {
    ...
    paddingHorizontal: 15, // Increased padding for better aesthetics
  ...
  productPrice: {
    color: '#FF6600',
    fontWeight: 'bold',
    marginTop: 5, // Increased margin for better separation
  },
});
